...
TITLE_FONT_SIZE = 60  # اندازه فونت عنوان
DIM_FONT_SIZE = 80
THICK_FONT_SIZE = 100
...
# مختصات دقیق پیکسلی برای مقادیر (خودت تغییر بده)
wt_pos = (700, 300)   # وسط بالا نزدیک به تصویر
wb_pos = (900, 2200)  # وسط پایین
hr_pos = (1600, 1300) # راست وسط تصویر
h_pos  = (200, 1300)  # چپ وسط تصویر
