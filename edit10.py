...
# تابع برای انتخاب پوشه خروجی به صورت پنجره گرافیکی
def select_output_dir(default_dir="out_images"):
    root = tk.Tk()
    root.withdraw()  # مخفی کردن پنجره اصلی
    folder_selected = filedialog.askdirectory(title="Select output directory")
    if not folder_selected:
        folder_selected = default_dir
...
# انتخاب پوشه خروجی با پنجره گرافیکی
